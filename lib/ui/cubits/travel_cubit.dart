...
class TravelCubit extends Cubit<TravelState>{
  ...
  Future<void> getTravels(String departure,String arrival) async{
    var travelQuery = travelCollection.where("departure",isEqualTo: departure).where("arrival",isEqualTo: arrival);
    emit(TravelLoading());
